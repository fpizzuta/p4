...
@push('body')
    <div class='wrapper'>
        <div id="page-content" class="page-content flexbox-col">
            <div class='list-item'>
                <span id='gameName'>{{$record->game->gameName}}</span><span id='gameDate'>{{$record->date}}</span></div>
            ...
            <div class='list-container'>
                <div class='list'>
                    ...
                    @foreach($match as $winner)
                        <div class="check-item">@if ($winner->winner == 1)
                                <i class="fas fa-check-circle"></i> @else &nbsp; @endif</div>
                    @endforeach
                </div>
            </div>
            <div class='list-container'>
